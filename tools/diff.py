...
if not objdump_executable:
    fail(
        "Missing binutils; please ensure one of mipsel-linux-gnu-objdump, mips-linux-gnu-objdump, mips64-elf-objdump, or mips-elf-objdump exists, or configure objdump_executable."
    )
